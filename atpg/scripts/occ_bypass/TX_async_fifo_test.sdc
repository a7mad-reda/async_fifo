...
# Clock Definitions
#-----------------------------------------------------------------------
create_clock -name src_clk  -period $period_src_clk [get_ports ate_wclk]
create_clock -name dest_clk -period $period_dest_clk [get_ports ate_rclk]
...
set_false_path -through snps_clk_chain_1/U_shftreg_0_ff_0_q_reg
