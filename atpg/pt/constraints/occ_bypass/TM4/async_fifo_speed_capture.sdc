###############################################################################
#
# Created by PrimeTime write_sdc on Thu Jan 27 08:08:48 2022
#
###############################################################################
...
###############################################################################
create_clock -name src_clk -period 3 -waveform { 0 1.5 } [get_ports {ate_wclk}]
set_clock_transition -rise -max  0.12 [get_clocks {src_clk}]
set_clock_transition -fall -max  0.12 [get_clocks {src_clk}]
create_clock -name dest_clk -period 7 -waveform { 0 3.5 } [get_ports {ate_rclk}]
...
set_false_path -through [get_pins {snps_clk_chain_1/U_shftreg_0_ff_0_q_reg/Q}] 
