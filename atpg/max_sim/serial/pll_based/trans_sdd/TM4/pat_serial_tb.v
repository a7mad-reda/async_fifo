...
// Thu Jan 27 08:08:59 2022
// Module under test: async_fifo
// Generated from original STIL file : "./patterns/pll_based/trans_sdd/stil/async_fifo_TM4.stil"
...
`define TDATA_FILE "/home/rfic/Desktop/adapted/async_fifo/tmax/./max_sim/serial/pll_based/trans_sdd/TM4/pat_serial_tb.dat"
`ifndef XTB_DUT_HIER 
...
`define MAXTB_HEADER " MAX TB Version O-2018.06-SP1\n Test Protocol File generated from original file \"./patterns/pll_based/trans_sdd/stil/async_fifo_TM4.stil\"\n STIL file version: 1.0"
`define MAXTB_H_S "#############################################################################"
...
module /* maxtb */ async_fifo_test ();
  ...
  endtask
   ...
   always @(start_part) begin: TM4_pattern__proc_unit
     ...
     if (diagm > 0) begin
       ...
       `else 
         diag_file = "./max_sim/serial/pll_based/trans_sdd/TM4/pat_serial_tb.diag"; 
       `endif
   ...
   initial begin: TM4_pattern__init_unit
     ...
     `ifdef tmax_vcde
       $display("XTB: Dumping Extended VCD information in file \"./max_sim/serial/pll_based/trans_sdd/TM4/pat_serial_tb.vcd\"");
       $dumpports(`XTB_DUT_HIER, "./max_sim/serial/pll_based/trans_sdd/TM4/pat_serial_tb.vcd");
     `endif
