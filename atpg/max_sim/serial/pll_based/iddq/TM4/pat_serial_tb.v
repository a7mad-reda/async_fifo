...
`define TDATA_FILE "/home/rfic/Desktop/adapted/async_fifo/atpg/./max_sim/serial/pll_based/iddq/TM4/pat_serial_tb.dat"
`ifndef XTB_DUT_HIER 
...
module /* maxtb */ async_fifo_test ();
  ...
  endtask
   ...
   begin
     ...
     assign_val('d`pll_bypass , 2'b01);
     assign_val('d`test_mode1 , 2'b01);
     assign_val('d`wclk , 2'bZ1);
     assign_val('d`rclk , 2'bZ1);
