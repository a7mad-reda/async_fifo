...
`define TDATA_FILE "/home/rfic/Desktop/adapted/async_fifo/tmax/./max_sim/serial/pll_based/path_delay/TM1/pat_serial_tb.dat"
`ifndef XTB_DUT_HIER 
...
module /* maxtb */ async_fifo_test ();
   ...
   parameter NINPUTS = 39, NOUTPUTS = 18, CUM_WIDTH=171;
   parameter NSIS = 4, NSOUTS = 4;
   parameter WFT_IDS = 2, SIG_IDS = 61, SIG_IDS_W = 6, MAX_WIDTH = 39, MAX_SIGW = 1;
   ...
   reg [8*NAMELENGTH-1:0]  SignalIDName [0:60];
   reg [2:0]  SignalIDType [0:60];
   reg [5:0]  SignalIDWidth [0:60];
   ...
   always begin: measure_sigs_p
    fork
     forever @(ALLOUTSIGS['d`\rdata[7] ]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`\rdata[7] ,ALLOUTSIGS[39], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[6] ]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`\rdata[6] ,ALLOUTSIGS[40], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[5] ]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`\rdata[5] ,ALLOUTSIGS[41], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[4] ]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`\rdata[4] ,ALLOUTSIGS[42], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[3] ]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`\rdata[3] ,ALLOUTSIGS[43], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[2] ]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`\rdata[2] ,ALLOUTSIGS[44], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[1] ]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`\rdata[1] ,ALLOUTSIGS[45], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[0] ]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`\rdata[0] ,ALLOUTSIGS[46], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`full]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`full,ALLOUTSIGS[47], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`empty]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`empty,ALLOUTSIGS[48], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`near_full]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`near_full,ALLOUTSIGS[49], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`near_empty]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`near_empty,ALLOUTSIGS[50], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`over_flow]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`over_flow,ALLOUTSIGS[51], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`under_flow]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`under_flow,ALLOUTSIGS[52], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`test_so,ALLOUTSIGS[53], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_1]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`test_so_1,ALLOUTSIGS[54], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_2]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`test_so_2,ALLOUTSIGS[55], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_3]) begin
       #0 if (cur_stmt == `VectorStmt ) measure_out_sig('d`test_so_3,ALLOUTSIGS[56], cur_stmt); 
     end
    join
   end 
  ...
  endtask
   ...
   begin
     ...
     //check_sid_args("test_setup",61'b1, idargs);
     resolve_wft(1);
   ...
   initial begin: TM1_pattern__init_unit
     ...
     SignalIDName[60] = "all_outputs";
     SignalIDType[60] = 3; //all_outputs
     SignalIDWidth[60] = 18; //all_outputs
