...
// Thu Jan 27 08:08:56 2022
// Module under test: async_fifo
// Generated from original STIL file : "./patterns/occ_bypass/trans_sdd/stil/async_fifo_TM4.stil"
...
`define TDATA_FILE "/home/rfic/Desktop/adapted/async_fifo/tmax/./max_sim/serial/occ_bypass/trans_sdd/TM4/pat_serial_tb.dat"
`ifndef XTB_DUT_HIER 
...
`define MAXTB_HEADER " MAX TB Version O-2018.06-SP1\n Test Protocol File generated from original file \"./patterns/occ_bypass/trans_sdd/stil/async_fifo_TM4.stil\"\n STIL file version: 1.0"
`define MAXTB_H_S "#############################################################################"
...
module /* maxtb */ async_fifo_test ();
   ...
   parameter MAXCHLEN = 10, NCHAINS = 24; // MAXCHLEN for serial
   parameter NINPUTS = 39, NOUTPUTS = 18, CUM_WIDTH=185;
   parameter NSIS = 4, NSOUTS = 4;
   parameter WFT_IDS = 4, SIG_IDS = 64, SIG_IDS_W = 7, MAX_WIDTH = 39, MAX_SIGW = 1;
   parameter PARSERINC = 10; 
   ...
   begin
     if (SignalIDType[sid] != 3) the_sids[0] = sid;
       ...
       case (sid)
         ...
         'd61: begin // _so
                 the_sids[3] = 53; the_sids[2] = 54; the_sids[1] = 55;
                 the_sids[0] = 56;
               end
         'd62: begin // _po
                 the_sids[17] = 48; the_sids[16] = 47; the_sids[15] = 50; the_sids[14] = 49; the_sids[13] = 51; the_sids[12] = 46; the_sids[11] = 45; the_sids[10] = 44; the_sids[9] = 43; the_sids[8] = 42; the_sids[7] = 41; the_sids[6] = 40; the_sids[5] = 39; the_sids[4] = 53; the_sids[3] = 52; the_sids[2] = 54; the_sids[1] = 55;
         ...
         'd63: begin // _si
                 the_sids[3] = 26; the_sids[2] = 36; the_sids[1] = 37;
                 the_sids[0] = 38;
               end
   ...
   always begin: measure_sigs_p
    fork
     forever @(ALLOUTSIGS['d`\rdata[7] ]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`\rdata[7] ,ALLOUTSIGS[39], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[6] ]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`\rdata[6] ,ALLOUTSIGS[40], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[5] ]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`\rdata[5] ,ALLOUTSIGS[41], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[4] ]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`\rdata[4] ,ALLOUTSIGS[42], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[3] ]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`\rdata[3] ,ALLOUTSIGS[43], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[2] ]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`\rdata[2] ,ALLOUTSIGS[44], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[1] ]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`\rdata[1] ,ALLOUTSIGS[45], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`\rdata[0] ]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`\rdata[0] ,ALLOUTSIGS[46], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`full]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`full,ALLOUTSIGS[47], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`empty]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`empty,ALLOUTSIGS[48], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`near_full]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`near_full,ALLOUTSIGS[49], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`near_empty]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`near_empty,ALLOUTSIGS[50], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`over_flow]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`over_flow,ALLOUTSIGS[51], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`under_flow]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`under_flow,ALLOUTSIGS[52], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so]) begin
       ...
       if (cur_stmt ==`load_unloadStmt) measure_scan_out('d`test_so,ALLOUTSIGS[53], 24); 
       else measure_out_sig('d`test_so,ALLOUTSIGS[53], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_1]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt )
       if (cur_stmt ==`load_unloadStmt) measure_scan_out('d`test_so_1,ALLOUTSIGS[54], 24); 
       else measure_out_sig('d`test_so_1,ALLOUTSIGS[54], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_2]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt )
       if (cur_stmt ==`load_unloadStmt) measure_scan_out('d`test_so_2,ALLOUTSIGS[55], 24); 
       else measure_out_sig('d`test_so_2,ALLOUTSIGS[55], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_3]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt )
       if (cur_stmt ==`load_unloadStmt) measure_scan_out('d`test_so_3,ALLOUTSIGS[56], 24); 
       else measure_out_sig('d`test_so_3,ALLOUTSIGS[56], cur_stmt); 
     end
    join
   end 
           ...
           if (ALLINSIGIDS[sid]==1'b1) begin
             for (n=0; n <SignalIDWidth[sid]; n=n+1) begin
               case ({TMPINSIGS_T[MAX_SIGW*sid+n],TMPINSIGS_V[MAX_SIGW*sid+n]})
                 ...
                 2'b0Z: begin    ALLINSIGS[MAX_SIGW*sid+n] <=    #(0) 1'bZ;   end
                 2'b0X: begin    ALLINSIGS[MAX_SIGW*sid+n] <=    #(0) 1'bX;   end
                 2'bZ1: begin    ALLINSIGS[MAX_SIGW*sid+n] <=    #(0) 1'b0;   ALLINSIGS[MAX_SIGW*sid+n] <=    #(97) 1'b1;   ALLINSIGS[MAX_SIGW*sid+n] <=    #(99) 1'b0;   end
                 default: undef_wfc({TMPINSIGS_T[MAX_SIGW*sid+n],TMPINSIGS_V[MAX_SIGW*sid+n]}, sid, 2);
               endcase
             end
           end
           ...
           if (ALLINSIGIDS[sid]==1'b1) begin
             for (n=0; n <SignalIDWidth[sid]; n=n+1) begin
               case ({TMPINSIGS_T[MAX_SIGW*sid+n],TMPINSIGS_V[MAX_SIGW*sid+n]})
                 ...
                 2'b0Z: begin    ALLINSIGS[MAX_SIGW*sid+n] <=    #(0) 1'bZ;   end
                 2'b0X: begin    ALLINSIGS[MAX_SIGW*sid+n] <=    #(0) 1'bX;   end
                 2'bZ1: begin    ALLINSIGS[MAX_SIGW*sid+n] <=    #(0) 1'b0;   ALLINSIGS[MAX_SIGW*sid+n] <=    #(2) 1'b1;   ALLINSIGS[MAX_SIGW*sid+n] <=    #(4) 1'b0;   end
                 default: undef_wfc({TMPINSIGS_T[MAX_SIGW*sid+n],TMPINSIGS_V[MAX_SIGW*sid+n]}, sid, 3);
               endcase
             end
           end
           ...
           if (ALLINSIGIDS[sid]==1'b1) begin
             for (n=0; n <SignalIDWidth[sid]; n=n+1) begin
               case ({TMPINSIGS_T[MAX_SIGW*sid+n],TMPINSIGS_V[MAX_SIGW*sid+n]})
                 ...
                 2'b0Z: begin    ALLINSIGS[MAX_SIGW*sid+n] <=    #(0) 1'bZ;   end
                 2'b0X: begin    ALLINSIGS[MAX_SIGW*sid+n] <=    #(0) 1'bX;   end
                 2'bZ1: begin    ALLINSIGS[MAX_SIGW*sid+n] <=    #(0) 1'b0;   ALLINSIGS[MAX_SIGW*sid+n] <=    #(4) 1'b1;   ALLINSIGS[MAX_SIGW*sid+n] <=    #(6) 1'b0;   end
                 default: undef_wfc({TMPINSIGS_T[MAX_SIGW*sid+n],TMPINSIGS_V[MAX_SIGW*sid+n]}, sid, 3);
               endcase
             end
           end
  ...
  endtask
   ...
   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT0[0:9] = {`XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_0_q_reg.Q , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_0_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_1_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_2_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_3_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_4_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_5_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_6_q_reg.D ,  LODCHP0[0] ,  LODCHP0[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT1[0:9] = {`XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_0_q_reg.Q , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_0_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_1_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_2_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_3_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_4_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_5_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_6_q_reg.D ,  LODCHP1[0] ,  LODCHP1[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT2[0:9] = {`XTB_DUT_HIER.R_2.Q , `XTB_DUT_HIER.R_2.SD , `XTB_DUT_HIER.R_1.SD , `XTB_DUT_HIER.R_0.SD , `XTB_DUT_HIER.sync_r2w.sync_out_reg_2_.D , `XTB_DUT_HIER.sync_r2w.temp_reg_2_.SD , `XTB_DUT_HIER.sync_r2w.sync_out_reg_1_.D , `XTB_DUT_HIER.sync_r2w.temp_reg_1_.SD , `XTB_DUT_HIER.sync_r2w.sync_out_reg_0_.D ,  LODCHP2[0] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT3[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_0__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_0__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__1_.SD ,  LODCHP3[0] ,  LODCHP3[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT4[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_1__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_1__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__1_.SD ,  LODCHP4[0] ,  LODCHP4[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT5[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_2__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_2__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__1_.SD ,  LODCHP5[0] ,  LODCHP5[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT6[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_3__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_3__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__1_.SD ,  LODCHP6[0] ,  LODCHP6[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT7[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_4__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_4__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__1_.SD ,  LODCHP7[0] ,  LODCHP7[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT8[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_5__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_5__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__1_.SD ,  LODCHP8[0] ,  LODCHP8[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT9[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_6__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_6__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__1_.SD ,  LODCHP9[0] ,  LODCHP9[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT10[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_7__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_7__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__1_.SD ,  LODCHP10[0] ,  LODCHP10[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT11[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_8__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_8__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__1_.SD ,  LODCHP11[0] ,  LODCHP11[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT12[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_9__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_9__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__1_.SD ,  LODCHP12[0] ,  LODCHP12[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT13[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_10__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_10__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__1_.SD ,  LODCHP13[0] ,  LODCHP13[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT14[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_11__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_11__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__1_.SD ,  LODCHP14[0] ,  LODCHP14[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT15[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_12__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_12__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__1_.SD ,  LODCHP15[0] ,  LODCHP15[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT16[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_13__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_13__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__1_.SD ,  LODCHP16[0] ,  LODCHP16[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT17[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_14__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_14__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__1_.SD ,  LODCHP17[0] ,  LODCHP17[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT18[0:9] = {`XTB_DUT_HIER.fifo_mem.mem_reg_15__7_.Q , `XTB_DUT_HIER.fifo_mem.mem_reg_15__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__1_.SD ,  LODCHP18[0] ,  LODCHP18[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT19[0:9] = {`XTB_DUT_HIER.wptr_full_wbin_reg_0_.Q , `XTB_DUT_HIER.wptr_full_wbin_reg_0_.SD , `XTB_DUT_HIER.wptr_full_over_flow_reg.SD , `XTB_DUT_HIER.wptr_full_near_full_reg.SD , `XTB_DUT_HIER.wptr_full_full_reg.SD , `XTB_DUT_HIER.sync_rst_w.dff2_reg.SD , `XTB_DUT_HIER.sync_rst_w.dff1_reg.SD , `XTB_DUT_HIER.sync_r2w.temp_reg_4_.SD ,  LODCHP19[0] ,  LODCHP19[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT20[0:9] = {`XTB_DUT_HIER.wptr_full_wptr_reg_3_.Q , `XTB_DUT_HIER.wptr_full_wptr_reg_3_.SD , `XTB_DUT_HIER.wptr_full_wptr_reg_2_.SD , `XTB_DUT_HIER.wptr_full_wptr_reg_1_.SD , `XTB_DUT_HIER.wptr_full_wptr_reg_0_.SD , `XTB_DUT_HIER.wptr_full_wbin_reg_4_.SD , `XTB_DUT_HIER.wptr_full_wbin_reg_3_.SD , `XTB_DUT_HIER.wptr_full_wbin_reg_2_.SD ,  LODCHP20[0] ,  LODCHP20[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT21[0:9] = {`XTB_DUT_HIER.sync_w2r.sync_out_reg_3_.Q , `XTB_DUT_HIER.sync_w2r.sync_out_reg_3_.D , `XTB_DUT_HIER.sync_w2r.temp_reg_3_.SD , `XTB_DUT_HIER.sync_w2r.sync_out_reg_2_.D , `XTB_DUT_HIER.sync_w2r.temp_reg_2_.SD , `XTB_DUT_HIER.sync_w2r.sync_out_reg_1_.D , `XTB_DUT_HIER.sync_w2r.temp_reg_1_.SD , `XTB_DUT_HIER.sync_w2r.sync_out_reg_0_.D ,  LODCHP21[0] ,  LODCHP21[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT22[0:9] = {`XTB_DUT_HIER.rptr_empty_rbin_reg_3_.Q , `XTB_DUT_HIER.rptr_empty_rbin_reg_3_.SD , `XTB_DUT_HIER.rptr_empty_rbin_reg_2_.SD , `XTB_DUT_HIER.rptr_empty_rbin_reg_1_.SD , `XTB_DUT_HIER.rptr_empty_rbin_reg_0_.SD , `XTB_DUT_HIER.rptr_empty_near_empty_reg.SD , `XTB_DUT_HIER.rptr_empty_empty_reg.SD , `XTB_DUT_HIER.sync_w2r.sync_out_reg_4_.D ,  LODCHP22[0] ,  LODCHP22[1] };
   end

   always /* ParallelShiftMode */ @(strobe_scells) begin
     CHAINOUT23[0:9] = {`XTB_DUT_HIER.sync_rst_r.dff2_reg.Q , `XTB_DUT_HIER.sync_rst_r.dff2_reg.SD , `XTB_DUT_HIER.sync_rst_r.dff1_reg.SD , `XTB_DUT_HIER.rptr_empty_under_flow_reg.SD , `XTB_DUT_HIER.rptr_empty_rptr_reg_3_.SD , `XTB_DUT_HIER.rptr_empty_rptr_reg_2_.SD , `XTB_DUT_HIER.rptr_empty_rptr_reg_1_.SD , `XTB_DUT_HIER.rptr_empty_rptr_reg_0_.SD ,  LODCHP23[0] ,  LODCHP23[1] };
   end
   ...
   endtask
   `define CELL0IN0 `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_7_q_reg.D
   `define CELL0IN1 `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_7_q_reg.D
   `define CELL0IN2 `XTB_DUT_HIER.sync_r2w.temp_reg_0_.SD
   `define CELL0IN3 `XTB_DUT_HIER.fifo_mem.mem_reg_0__0_.SD
   `define CELL0IN4 `XTB_DUT_HIER.fifo_mem.mem_reg_1__0_.SD
   `define CELL0IN5 `XTB_DUT_HIER.fifo_mem.mem_reg_2__0_.SD
   `define CELL0IN6 `XTB_DUT_HIER.fifo_mem.mem_reg_3__0_.SD
   `define CELL0IN7 `XTB_DUT_HIER.fifo_mem.mem_reg_4__0_.SD
   `define CELL0IN8 `XTB_DUT_HIER.fifo_mem.mem_reg_5__0_.SD
   `define CELL0IN9 `XTB_DUT_HIER.fifo_mem.mem_reg_6__0_.SD
   `define CELL0IN10 `XTB_DUT_HIER.fifo_mem.mem_reg_7__0_.SD
   `define CELL0IN11 `XTB_DUT_HIER.fifo_mem.mem_reg_8__0_.SD
   `define CELL0IN12 `XTB_DUT_HIER.fifo_mem.mem_reg_9__0_.SD
   `define CELL0IN13 `XTB_DUT_HIER.fifo_mem.mem_reg_10__0_.SD
   `define CELL0IN14 `XTB_DUT_HIER.fifo_mem.mem_reg_11__0_.SD
   `define CELL0IN15 `XTB_DUT_HIER.fifo_mem.mem_reg_12__0_.SD
   `define CELL0IN16 `XTB_DUT_HIER.fifo_mem.mem_reg_13__0_.SD
   `define CELL0IN17 `XTB_DUT_HIER.fifo_mem.mem_reg_14__0_.SD
   `define CELL0IN18 `XTB_DUT_HIER.fifo_mem.mem_reg_15__0_.SD
   `define CELL0IN19 `XTB_DUT_HIER.sync_r2w.temp_reg_3_.SD
   `define CELL0IN20 `XTB_DUT_HIER.wptr_full_wbin_reg_1_.SD
   `define CELL0IN21 `XTB_DUT_HIER.sync_w2r.temp_reg_0_.SD
   `define CELL0IN22 `XTB_DUT_HIER.sync_w2r.temp_reg_4_.SD
   `define CELL0IN23 `XTB_DUT_HIER.rptr_empty_rbin_reg_4_.SD
   `define CHAININ0 {`XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_0_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_1_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_2_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_3_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_4_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_5_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_0.U_shftreg_0_ff_6_q_reg.D ,  `CELL0IN0 }

   `define CHAININ1 {`XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_0_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_1_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_2_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_3_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_4_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_5_q_reg.D , `XTB_DUT_HIER.snps_clk_chain_1.U_shftreg_0_ff_6_q_reg.D ,  `CELL0IN1 }

   `define CHAININ2 {`XTB_DUT_HIER.R_2.SD , `XTB_DUT_HIER.R_1.SD , `XTB_DUT_HIER.R_0.SD , `XTB_DUT_HIER.sync_r2w.sync_out_reg_2_.D , `XTB_DUT_HIER.sync_r2w.temp_reg_2_.SD , `XTB_DUT_HIER.sync_r2w.sync_out_reg_1_.D , `XTB_DUT_HIER.sync_r2w.temp_reg_1_.SD , `XTB_DUT_HIER.sync_r2w.sync_out_reg_0_.D ,  `CELL0IN2 }

   `define CHAININ3 {`XTB_DUT_HIER.fifo_mem.mem_reg_0__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_0__1_.SD ,  `CELL0IN3 }

   `define CHAININ4 {`XTB_DUT_HIER.fifo_mem.mem_reg_1__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_1__1_.SD ,  `CELL0IN4 }

   `define CHAININ5 {`XTB_DUT_HIER.fifo_mem.mem_reg_2__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_2__1_.SD ,  `CELL0IN5 }

   `define CHAININ6 {`XTB_DUT_HIER.fifo_mem.mem_reg_3__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_3__1_.SD ,  `CELL0IN6 }

   `define CHAININ7 {`XTB_DUT_HIER.fifo_mem.mem_reg_4__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_4__1_.SD ,  `CELL0IN7 }

   `define CHAININ8 {`XTB_DUT_HIER.fifo_mem.mem_reg_5__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_5__1_.SD ,  `CELL0IN8 }

   `define CHAININ9 {`XTB_DUT_HIER.fifo_mem.mem_reg_6__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_6__1_.SD ,  `CELL0IN9 }

   `define CHAININ10 {`XTB_DUT_HIER.fifo_mem.mem_reg_7__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_7__1_.SD ,  `CELL0IN10 }

   `define CHAININ11 {`XTB_DUT_HIER.fifo_mem.mem_reg_8__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_8__1_.SD ,  `CELL0IN11 }

   `define CHAININ12 {`XTB_DUT_HIER.fifo_mem.mem_reg_9__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_9__1_.SD ,  `CELL0IN12 }

   `define CHAININ13 {`XTB_DUT_HIER.fifo_mem.mem_reg_10__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_10__1_.SD ,  `CELL0IN13 }

   `define CHAININ14 {`XTB_DUT_HIER.fifo_mem.mem_reg_11__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_11__1_.SD ,  `CELL0IN14 }

   `define CHAININ15 {`XTB_DUT_HIER.fifo_mem.mem_reg_12__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_12__1_.SD ,  `CELL0IN15 }

   `define CHAININ16 {`XTB_DUT_HIER.fifo_mem.mem_reg_13__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_13__1_.SD ,  `CELL0IN16 }

   `define CHAININ17 {`XTB_DUT_HIER.fifo_mem.mem_reg_14__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_14__1_.SD ,  `CELL0IN17 }

   `define CHAININ18 {`XTB_DUT_HIER.fifo_mem.mem_reg_15__7_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__6_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__5_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__4_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__3_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__2_.SD , `XTB_DUT_HIER.fifo_mem.mem_reg_15__1_.SD ,  `CELL0IN18 }

   `define CHAININ19 {`XTB_DUT_HIER.wptr_full_wbin_reg_0_.SD , `XTB_DUT_HIER.wptr_full_over_flow_reg.SD , `XTB_DUT_HIER.wptr_full_near_full_reg.SD , `XTB_DUT_HIER.wptr_full_full_reg.SD , `XTB_DUT_HIER.sync_rst_w.dff2_reg.SD , `XTB_DUT_HIER.sync_rst_w.dff1_reg.SD , `XTB_DUT_HIER.sync_r2w.temp_reg_4_.SD ,  `CELL0IN19 }

   `define CHAININ20 {`XTB_DUT_HIER.wptr_full_wptr_reg_3_.SD , `XTB_DUT_HIER.wptr_full_wptr_reg_2_.SD , `XTB_DUT_HIER.wptr_full_wptr_reg_1_.SD , `XTB_DUT_HIER.wptr_full_wptr_reg_0_.SD , `XTB_DUT_HIER.wptr_full_wbin_reg_4_.SD , `XTB_DUT_HIER.wptr_full_wbin_reg_3_.SD , `XTB_DUT_HIER.wptr_full_wbin_reg_2_.SD ,  `CELL0IN20 }

   `define CHAININ21 {`XTB_DUT_HIER.sync_w2r.sync_out_reg_3_.D , `XTB_DUT_HIER.sync_w2r.temp_reg_3_.SD , `XTB_DUT_HIER.sync_w2r.sync_out_reg_2_.D , `XTB_DUT_HIER.sync_w2r.temp_reg_2_.SD , `XTB_DUT_HIER.sync_w2r.sync_out_reg_1_.D , `XTB_DUT_HIER.sync_w2r.temp_reg_1_.SD , `XTB_DUT_HIER.sync_w2r.sync_out_reg_0_.D ,  `CELL0IN21 }

   `define CHAININ22 {`XTB_DUT_HIER.rptr_empty_rbin_reg_3_.SD , `XTB_DUT_HIER.rptr_empty_rbin_reg_2_.SD , `XTB_DUT_HIER.rptr_empty_rbin_reg_1_.SD , `XTB_DUT_HIER.rptr_empty_rbin_reg_0_.SD , `XTB_DUT_HIER.rptr_empty_near_empty_reg.SD , `XTB_DUT_HIER.rptr_empty_empty_reg.SD , `XTB_DUT_HIER.sync_w2r.sync_out_reg_4_.D ,  `CELL0IN22 }

   `define CHAININ23 {`XTB_DUT_HIER.sync_rst_r.dff2_reg.SD , `XTB_DUT_HIER.sync_rst_r.dff1_reg.SD , `XTB_DUT_HIER.rptr_empty_under_flow_reg.SD , `XTB_DUT_HIER.rptr_empty_rptr_reg_3_.SD , `XTB_DUT_HIER.rptr_empty_rptr_reg_2_.SD , `XTB_DUT_HIER.rptr_empty_rptr_reg_1_.SD , `XTB_DUT_HIER.rptr_empty_rptr_reg_0_.SD ,  `CELL0IN23 }
   ...
   task p_shift_0 ;
     ...
     integer i, j;
   begin
     if (~(idargs[63] | idargs[26] | idargs[36] | idargs[37] | idargs[38] | idargs[61] | idargs[53] | idargs[54] | idargs[55] | idargs[56] )) 
       disable p_shift_0 ; 
     ...
     fork 
       begin: b1 
         ...
         if (idargs[26] === 1'b1 || idargs[36] === 1'b1 || idargs[37] === 1'b1 || idargs[38] === 1'b1) begin 
   ...
   begin
     ...
     assign_val('d`all_inputs , 78'b0000000000000000000000000000000000000001XXXXXXXXXX0XX110X0XXXXXXXXXX1000111XXX);
     assign_val('d`all_outputs , 36'b111111111111111111XXXXXXXXXXXXXXXXXX);
     ...
     if (idargs[62] === 1'b1) assign_ival('d`_po );
   ...
   begin
     ...
     //check_sid_args("allclock_launch",64'b1, idargs);
     save_context;
     resolve_wft(2);
   ...
   begin
     ...
     //check_sid_args("allclock_capture",64'b1, idargs);
     save_context;
     resolve_wft(3);
   ...
   always @(start_part) begin: TM4_occ_bypass_pattern__proc_unit
     ...
     if (diagm > 0) begin
       ...
       `else 
         diag_file = "./max_sim/serial/occ_bypass/trans_sdd/TM4/pat_serial_tb.diag"; 
       `endif
   ...
   initial begin: TM4_occ_bypass_pattern__init_unit
     ...
     SignalIDName[59] = "all_outputs";
     SignalIDType[59] = 3; //all_outputs
     SignalIDWidth[59] = 18; //all_outputs
     SignalIDName[60] = "_clk";
     SignalIDType[60] = 3; //_clk
     SignalIDWidth[60] = 6; //_clk
     SignalIDName[61] = "_so";
     SignalIDType[61] = 3; //_so
     SignalIDWidth[61] = 4; //_so
     SignalIDName[62] = "_po";
     SignalIDType[62] = 3; //_po
     SignalIDWidth[62] = 18; //_po
     SignalIDName[63] = "_si";
     SignalIDType[63] = 3; //_si
     SignalIDWidth[63] = 4; //_si
     ...
     `ifdef tmax_vcde
       $display("XTB: Dumping Extended VCD information in file \"./max_sim/serial/occ_bypass/trans_sdd/TM4/pat_serial_tb.vcd\"");
       $dumpports(`XTB_DUT_HIER, "./max_sim/serial/occ_bypass/trans_sdd/TM4/pat_serial_tb.vcd");
     `endif
     ...
     CH_OUTINV[0] = 10'b0000000000;
     CH_INPINV[0] = 10'b0000000000;
     CH_OUTINV[1] = 10'b0000000000;
     CH_INPINV[1] = 10'b0000000000;
     CH_OUTINV[2] = 10'b0000000000;
     CH_INPINV[2] = 10'b0000000000;
     CH_OUTINV[3] = 10'b0000000000;
     CH_INPINV[3] = 10'b0000000000;
     CH_OUTINV[4] = 10'b0000000000;
     CH_INPINV[4] = 10'b0000000000;
     CH_OUTINV[5] = 10'b0000000000;
     CH_INPINV[5] = 10'b0000000000;
     CH_OUTINV[6] = 10'b0000000000;
     CH_INPINV[6] = 10'b0000000000;
     CH_OUTINV[7] = 10'b0000000000;
     CH_INPINV[7] = 10'b0000000000;
     CH_OUTINV[8] = 10'b0000000000;
     CH_INPINV[8] = 10'b0000000000;
     CH_OUTINV[9] = 10'b0000000000;
     CH_INPINV[9] = 10'b0000000000;
     CH_OUTINV[10] = 10'b0000000000;
     CH_INPINV[10] = 10'b0000000000;
     CH_OUTINV[11] = 10'b0000000000;
     CH_INPINV[11] = 10'b0000000000;
     CH_OUTINV[12] = 10'b0000000000;
     CH_INPINV[12] = 10'b0000000000;
     CH_OUTINV[13] = 10'b0000000000;
     CH_INPINV[13] = 10'b0000000000;
     CH_OUTINV[14] = 10'b0000000000;
     CH_INPINV[14] = 10'b0000000000;
     CH_OUTINV[15] = 10'b0000000000;
     CH_INPINV[15] = 10'b0000000000;
     CH_OUTINV[16] = 10'b0000000000;
     CH_INPINV[16] = 10'b0000000000;
     CH_OUTINV[17] = 10'b0000000000;
     CH_INPINV[17] = 10'b0000000000;
     CH_OUTINV[18] = 10'b0000000000;
     CH_INPINV[18] = 10'b0000000000;
     CH_OUTINV[19] = 10'b0000000000;
     CH_INPINV[19] = 10'b0000000000;
     CH_OUTINV[20] = 10'b0000000000;
     CH_INPINV[20] = 10'b0000000000;
     CH_OUTINV[21] = 10'b0000000000;
     CH_INPINV[21] = 10'b0000000000;
     CH_OUTINV[22] = 10'b0000000000;
     CH_INPINV[22] = 10'b0000000000;
     CH_OUTINV[23] = 10'b0000000000;
     CH_INPINV[23] = 10'b0000000000;
...
reg    test_so, test_so_1, test_so_2, test_so_3;
 ...
 module async_fifo_test_SDF_ANN;
   initial $sdf_annotate("../pt/sdf/async_fifo.sdf", async_fifo_test.dut);
 endmodule
