...
// Thu Jan 27 08:08:55 2022
// Module under test: async_fifo
// Generated from original STIL file : "./patterns/occ_bypass/trans_sdd/stil/async_fifo_TM3.stil"
...
`define TDATA_FILE "/home/rfic/Desktop/adapted/async_fifo/tmax/./max_sim/serial/occ_bypass/trans_sdd/TM3/pat_serial_tb.dat"
`ifndef XTB_DUT_HIER 
...
`define MAXTB_HEADER " MAX TB Version O-2018.06-SP1\n Test Protocol File generated from original file \"./patterns/occ_bypass/trans_sdd/stil/async_fifo_TM3.stil\"\n STIL file version: 1.0"
`define MAXTB_H_S "#############################################################################"
...
module /* maxtb */ async_fifo_test ();
   ...
   always begin: measure_sigs_p
    fork
     ...
     forever @(ALLOUTSIGS['d`test_so_1]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`test_so_1,ALLOUTSIGS[54], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_2]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`test_so_2,ALLOUTSIGS[55], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_3]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt || cur_stmt == `allclock_launchStmt || cur_stmt == `allclock_captureStmt ) measure_out_sig('d`test_so_3,ALLOUTSIGS[56], cur_stmt); 
     end
    join
   end 
  ...
  endtask
   ...
   begin
    ...
    while (csci < 193) begin
     ...
     assign_val('d`_clk , 12'bZ0Z0ZZ111111);
         if (idargs[63] === 1'b1 || idargs[26] === 1'b1) begin 
           LOD=LOAD[0]; assign_val('d`test_si , {1'b0, LOD[csci+0]});
         end
         if(stroben && (idargs[61] === 1'b1 || idargs[53] === 1'b1)) begin 
   ...
   task p_shift_0 ;
     ...
     integer i, j;
   begin
     if (~(idargs[63] | idargs[26] | idargs[61] | idargs[53] )) 
       disable p_shift_0 ; 
     ...
     fork 
       begin: b1 
         ...
         if (idargs[61] === 1'b1 ||  idargs[53] === 1'b1) begin 
   ...
   always @(start_part) begin: TM3_occ_bypass_pattern__proc_unit
     ...
     if (diagm > 0) begin
       ...
       `else 
         diag_file = "./max_sim/serial/occ_bypass/trans_sdd/TM3/pat_serial_tb.diag"; 
       `endif
   ...
   initial begin: TM3_occ_bypass_pattern__init_unit
     ...
     `ifdef tmax_vcde
       $display("XTB: Dumping Extended VCD information in file \"./max_sim/serial/occ_bypass/trans_sdd/TM3/pat_serial_tb.vcd\"");
       $dumpports(`XTB_DUT_HIER, "./max_sim/serial/occ_bypass/trans_sdd/TM3/pat_serial_tb.vcd");
     `endif
