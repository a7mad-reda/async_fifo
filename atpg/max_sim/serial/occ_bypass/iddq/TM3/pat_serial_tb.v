...
// Generated from original STIL file : "./patterns/occ_bypass/iddq/stil/async_fifo_TM3.stil"
...
`define TDATA_FILE "/home/rfic/Desktop/adapted/async_fifo/tmax/./max_sim/serial/occ_bypass/iddq/TM3/pat_serial_tb.dat"
`ifndef XTB_DUT_HIER 
...
`define MAXTB_HEADER " MAX TB Version O-2018.06-SP1\n Test Protocol File generated from original file \"./patterns/occ_bypass/iddq/stil/async_fifo_TM3.stil\"\n STIL file version: 1.0"
`define MAXTB_H_S "#############################################################################"
   ...
   always begin: measure_sigs_p
    fork
     ...
     forever @(ALLOUTSIGS['d`test_so_1]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `iddq_captureStmt ) measure_out_sig('d`test_so_1,ALLOUTSIGS[54], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_2]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `iddq_captureStmt ) measure_out_sig('d`test_so_2,ALLOUTSIGS[55], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_3]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `iddq_captureStmt ) measure_out_sig('d`test_so_3,ALLOUTSIGS[56], cur_stmt); 
     end
    join
   end 
  ...
  endtask
   ...
   always @(start_part) begin: TM3_occ_bypass_pattern__proc_unit
     ...
     if (diagm > 0) begin
       ...
       `else 
         diag_file = "./max_sim/serial/occ_bypass/iddq/TM3/pat_serial_tb.diag"; 
       `endif
   ...
   initial begin: TM3_occ_bypass_pattern__init_unit
     ...
     `ifdef tmax_vcde
       $display("XTB: Dumping Extended VCD information in file \"./max_sim/serial/occ_bypass/iddq/TM3/pat_serial_tb.vcd\"");
       $dumpports(`XTB_DUT_HIER, "./max_sim/serial/occ_bypass/iddq/TM3/pat_serial_tb.vcd");
     `endif
