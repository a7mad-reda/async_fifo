...
`define TDATA_FILE "/home/rfic/Desktop/adapted/async_fifo/tmax/./max_sim/parallel/occ_bypass/stuck/TM3/pat_parallel_tb.dat"
`ifndef XTB_DUT_HIER 
  ...
  endtask
   ...
   always @(start_part) begin: TM3_occ_bypass_pattern__proc_unit
     ...
     if (diagm > 0) begin
       ...
       `else 
         diag_file = "./max_sim/parallel/occ_bypass/stuck/TM3/pat_parallel_tb.diag"; 
       `endif
   ...
   initial begin: TM3_occ_bypass_pattern__init_unit
     ...
     `ifdef tmax_vcde
       $display("XTB: Dumping Extended VCD information in file \"./max_sim/parallel/occ_bypass/stuck/TM3/pat_parallel_tb.vcd\"");
       $dumpports(`XTB_DUT_HIER, "./max_sim/parallel/occ_bypass/stuck/TM3/pat_parallel_tb.vcd");
     `endif
