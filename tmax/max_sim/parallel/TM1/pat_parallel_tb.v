...
// Generated from original STIL file : "./patterns/async_fifo_TM1.stil"
...
`define TDATA_FILE "/home/rfic/Desktop/adapted/async_fifo/tmax/./max_sim/parallel/TM1/pat_parallel_tb.dat"
`ifndef XTB_DUT_HIER 
...
`define MAXTB_HEADER " MAX TB Version O-2018.06-SP1\n Test Protocol File generated from original file \"./patterns/async_fifo_TM1.stil\"\n STIL file version: 1.0"
`define MAXTB_H_S "#############################################################################"
...
module /* maxtb */ async_fifo_test ();
   ...
   parameter MAXCHLEN = 45, NCHAINS = 4; // MAXCHLEN for serial
   ...
   always begin: measure_sigs_p
    fork
     ...
     forever @(ALLOUTSIGS['d`test_so]) begin
       ...
       if (cur_stmt ==`load_unloadStmt) measure_scan_out('d`test_so,ALLOUTSIGS[49], 0); 
       else measure_out_sig('d`test_so,ALLOUTSIGS[49], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_1]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt )
       if (cur_stmt ==`load_unloadStmt) measure_scan_out('d`test_so_1,ALLOUTSIGS[50], 1); 
       else measure_out_sig('d`test_so_1,ALLOUTSIGS[50], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_2]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt )
       if (cur_stmt ==`load_unloadStmt) measure_scan_out('d`test_so_2,ALLOUTSIGS[51], 2); 
       else measure_out_sig('d`test_so_2,ALLOUTSIGS[51], cur_stmt); 
     end
     forever @(ALLOUTSIGS['d`test_so_3]) begin
       #0 if (cur_stmt == `VectorStmt || cur_stmt == `load_unloadStmt || cur_stmt == `multiclock_captureStmt )
       if (cur_stmt ==`load_unloadStmt) measure_scan_out('d`test_so_3,ALLOUTSIGS[52], 3); 
  ...
  endtask
   ...
   begin
     ...
     assign_val('d`all_inputs , 70'b000000000000000000000000000000000001XXXXXXXXXXXXX100XXXXXXXXXXXXX10XXX);
     assign_val('d`all_outputs , 36'b111111111111111111XXXXXXXXXXXXXXXXXX);
   ...
   always @(start_part) begin: _burst__pattern__proc_unit
     ...
     if (diagm > 0) begin
       ...
       `else 
         diag_file = "./max_sim/parallel/TM1/pat_parallel_tb.diag"; 
       `endif
   ...
   initial begin: _burst__pattern__init_unit
     ...
     `ifdef tmax_vcde
       $display("XTB: Dumping Extended VCD information in file \"./max_sim/parallel/TM1/pat_parallel_tb.vcd\"");
       $dumpports(`XTB_DUT_HIER, "./max_sim/parallel/TM1/pat_parallel_tb.vcd");
     `endif
     ...
     CH_NAMES[3] = "4";
     CH_PINS[3] = "test_so_3";
     CH_OUTINV[0] = 45'b000000000000000000000000000000000000000000000;
     CH_INPINV[0] = 45'b000000000000000000000000000000000000000000000;
     CH_OUTINV[1] = 45'b000000000000000000000000000000000000000000000;
     CH_INPINV[1] = 45'b000000000000000000000000000000000000000000000;
     CH_OUTINV[2] = 45'b000000000000000000000000000000000000000000000;
     CH_INPINV[2] = 45'b000000000000000000000000000000000000000000000;
     CH_OUTINV[3] = 45'b000000000000000000000000000000000000000000000;
     CH_INPINV[3] = 45'b000000000000000000000000000000000000000000000;
