...
# Creation time: Fri Jan  7 05:59:25 2022
# tmax2pt.tcl version: N-2017.09: 2017/08/04 18:10:33 
# arguments: ./max_sim/pt/TM4/async_fifo_capture.tcl -mode capture -replace
...
set_false_path -hold -from                     [get_clocks test_clk_wft1 ] -to [get_clocks wrst_n_wft1 ]
set_multicycle_path -setup 2 -rise_from                     [get_clocks test_clk_wft1 ] -rise_to [get_clocks wrst_n_wft1 ]
set_false_path -hold -from                     [get_clocks test_clk_wft1 ] -to [get_clocks rrst_n_wft1 ]
set_multicycle_path -setup 2 -rise_from                     [get_clocks test_clk_wft1 ] -rise_to [get_clocks rrst_n_wft1 ]
set_false_path -hold -from                     [get_clocks wrst_n_wft1 ] -to [get_clocks test_clk_wft1 ]
set_multicycle_path -setup 2 -fall_from                     [get_clocks wrst_n_wft1 ] -fall_to [get_clocks test_clk_wft1 ]
set_false_path -hold -from                     [get_clocks rrst_n_wft1 ] -to [get_clocks test_clk_wft1 ]
set_multicycle_path -setup 2 -fall_from                     [get_clocks rrst_n_wft1 ] -fall_to [get_clocks test_clk_wft1 ]
...
set_case_analysis 1 [get_ports test_mode1]
